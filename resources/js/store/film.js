...
export default {
    ...
    actions: {
        getFilmData({commit}, slug) {
            axios
                .get(process.env.MIX_API_URL + "/api/films/" + slug)
                .then(response => {
        ...
        getCountriesCollectionData({commit}) {
            axios
                .get(process.env.MIX_API_URL + "/api/countries")
                .then(response => {
        ...
        createFilmRequest({commit}, data) {
            ...
            return axios
                .post(process.env.MIX_API_URL + "/api/films", data)
                .then(response => {
                    commit("setFilmData", response.data);
                });
        },
        deleteFilmRequest({commit}, id) {
            commit("setErrors", {}, {root: true});
            return axios
                .post(process.env.MIX_API_URL + "/api/films/" + id)
                .then(response => {
        ...
        addCommentRequest({commit}, data) {
            commit("setErrors", {}, {root: true});
            return axios
                .post(process.env.MIX_API_URL + "/api/comment", data)
                .then(response => {
                    return response
                })
                .catch(error => {
